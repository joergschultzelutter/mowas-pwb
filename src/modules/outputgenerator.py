    ...
    for mowas_message_id in mowas_messages_to_send:
        ...
        for coords in coords_matching_latlon:
            ...
            if success:
                ...
                # Get the UTM data for the current coordinates
                zone_number, zone_letter, easting, northing = convert_latlon_to_utm(
                    latitude=latitude, longitude=longitude
                )
                utm = f"{zone_number} {zone_letter} {easting} {northing}"

                # Get the Maidenhead locator for the current coordinates
                maidenhead = convert_latlon_to_maidenhead(
                    latitude=latitude, longitude=longitude, output_precision=4
                )
...
if __name__ == "__main__":
    ...
    mowas_messages_to_send = {
        "DE-BY-A-W083-20200828-000": {
            ...
            "msgtype": "Alert",
            "areas": ["Gemeinde/Stadt: Stadt Gersthofen, Gemeinde Gablingen"],
            "areas_matching_latlon_abbrev": ["Stadt Gersthofen, Gemeinde Gablingen"],
            ...
            "contact": "Bei R\u00fcckfragen k\u00f6nnen sich B\u00fcrgerinnen und B\u00fcrger an die Stadtwerke Gersthofen oder die Stadt Gersthofen wenden.0821/2491-0 -  0821/2491-0",
            "lang": "en-us",
            "lang_headline": "Temporary change in drinking water quality: chlorination still exists",
            "lang_description": "Chlorination continues to exist.",
            "lang_instruction": "Inform yourself in the media, for example on the local radio.The water no longer needs to be boiled.",
            "lang_contact": "If you have any questions, citizens can contact the Gersthofen public utility company or the city of Gersthofen.0821/2491-0 - 0821/2491-0"
        }
    }
    # fmt: on

...
def get_position_on_aprsfi(
	aprsfi_callsign: str, aprsdotfi_api_key: str
):
	"""
...
if __name__ == "__main__":
	success, mowas_aprsdotfi_api_key, mowas_dapnet_login_callsign, mowas_dapnet_login_passcode, mowas_watch_areas, mowas_telegram_bot_token = get_program_config_from_file()
	if success:

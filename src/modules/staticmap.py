...
def render_png_map(polygon_area: list,monitoring_positions: list, aprs_latitude: float, aprs_longitude: float):
    ...
    for position in monitoring_positions:
        ...
        marker_color = staticmaps.GREEN if latitude == aprs_latitude and longitude == aprs_longitude else staticmaps.RED
        context.add_object(staticmaps.Marker(staticmaps.create_latlng(latitude, longitude), color=marker_color, size=12))
...
if __name__ == "__main__":
    ...
    render_png_map(polygon,markers,48.4781,10.773)
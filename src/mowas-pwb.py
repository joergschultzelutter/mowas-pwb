...
if __name__ == "__main__":
    ...
    mowas_aprsdotfi_enabled = (
        False if mowas_aprsdotfi_api_key == "NOT_CONFIGURED" else True
    )
    mowas_dapnet_enabled = (
        False if mowas_dapnet_login_callsign == "NOT_CONFIGURED" else True
    )
    mowas_telegram_enabled = (
        False if mowas_telegram_bot_token == "NOT_CONFIGURED" else True
    )
